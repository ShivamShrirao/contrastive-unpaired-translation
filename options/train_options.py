...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # training parameters
        parser.add_argument('--no_amp', action='store_true', help="Do not use mixed precision training.")
        ...
        parser.add_argument('--lr_schedule', action='store_true', help="Do learning rate scheduling.")
